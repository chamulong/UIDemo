...
class MainUi(QtWidgets.QMainWindow):
    """
    程序主窗体，完全参考：https://zmister.com/archives/477.html
    """
    def  __init__(self):
        """构造函数"""
        super().__init__()
    ...
    def init_ui(self):
        apppath =os.path.abspath('.')#获取当前脚本所在路径的上一级路径
        """主窗体布局"""
        ...
        self.setCentralWidget(self.main_widget) #设置窗口主部件居中
        ...
        self.recommend_button_1.setIcon(QtGui.QIcon(apppath+'/data/r1.jpg'))  # 设置按钮图标
        ...
        self.recommend_button_2.setIcon(QtGui.QIcon(apppath+'/data/r2.jpg'))
        ...
        self.recommend_button_3.setIcon(QtGui.QIcon(apppath+'/data/r3.jpg'))
        ...
        self.recommend_button_4.setIcon(QtGui.QIcon(apppath+'/data/r4.jpg'))
        ...
        self.recommend_button_5.setIcon(QtGui.QIcon(apppath+'/data/r5.jpg'))
        ...
        self.playlist_button_1.setIcon(QtGui.QIcon(apppath+'/data/p1.jpg'))
        ...
        self.playlist_button_2.setIcon(QtGui.QIcon(apppath+'/data/p2.jpg'))
        ...
        self.playlist_button_3.setIcon(QtGui.QIcon(apppath+'/data/p3.jpg'))
        ...
        self.playlist_button_4.setIcon(QtGui.QIcon(apppath+'/data/p4.jpg'))
        ...
        self.right_process_bar.setValue(15)
        ...
        self.console_button_1 = QtWidgets.QPushButton(qtawesome.icon('fa.backward', color='#00AEAE'), "")
        self.console_button_2 = QtWidgets.QPushButton(qtawesome.icon('fa.forward', color='#00AEAE'), "")
        self.console_button_3 = QtWidgets.QPushButton(qtawesome.icon('fa.pause', color='#00AEAE', font=18), "")
        ...
        """利用Qt StyleSheet控制右侧背景、搜索框和模块文本的样式"""
        ...
        """利用Qt StyleSheet控制荐模块、歌单模块和歌曲列表模块的样式(QToolButton()部件)"""
        self.right_recommend_widget.setStyleSheet(
            '''
                QToolButton{border:none;}
                QToolButton:hover{border-bottom:1px solid #F76677;}
            ''')
        ...
        """利用Qt StyleSheet控制音乐列表的样式(QPushButton()部件)"""
        ...
        """liyong PyQt5各个部件的其它属性来完成图形界面的最终美化工作
        self.setWindowOpacity(0.9)  # 设置窗口透明度
        self.setAttribute(QtCore.Qt.WA_TranslucentBackground)  # 设置窗口背景透明
        self.setWindowFlag(QtCore.Qt.FramelessWindowHint)  # 隐藏边框

        self.main_layout.setSpacing(0)#去掉左侧部件和右侧部件中有一条缝隙
        """
